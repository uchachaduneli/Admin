...
import {CompanyServicesService, ServiceBackendApi} from '../services/company-services.service';
...
export class ServiceListComponent implements AfterViewInit {
  ...
  constructor(public dialog: MatDialog, private service: CompanyServicesService,
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(ServiceDialogContent, {data: obj, maxWidth: '50%'});
    // @ts-ignore
...
export class ServiceDialogContent implements OnInit {
  action: string;
  selectedObject: any;

  constructor(public dialogRef: MatDialogRef<ServiceDialogContent>,
